...
export const useButtonClassname = (size: ButtonSize) => {
  ...
  return clsx(
    ...
    "text-primary font-inter rounded font-medium tracking-widest transition-all from-accent/35 to-highlight/65 bg-gradient-to-r hover:hue-rotate-[15deg] font-semibold active:brightness-90",
